...
export interface PresenceLogEntry {
    ...
    type?: "presence" | "profile" | "message" | "typing" | "voice" | "mutual_friend";
    ...
    // Mutual friend fields
    mutualFriendId?: string;
    mutualFriendUsername?: string;
}
...
export interface UserStalkerConfig {
    ...
    notifyVoiceJoin?: boolean;
    notifyVoiceLeave?: boolean;
    // Mutual friend notifications
    notifyMutualFriend?: boolean;
}
